              ...
              >
                ...
                {activeTab === "quiz" && studyBoard?.content?.quiz && studyBoard.content.quiz.length > 0 && (
                  ...
                  >
                    <div className="flex items-center space-x-3 mb-4">
                      <div className="bg-[#74AA9C]/20 p-2 rounded-lg">
                        <Target className="w-5 h-5 text-[#74AA9C]" />
                      </div>
                      <h2 className="text-xl font-semibold text-[#74AA9C]">Quiz Questions</h2>
                    </div>
                    <div className="space-y-6">
                      {studyBoard.content.quiz.map((question, qIndex) => {
                        ...
                        return (
                          <div
                            key={qIndex}
                            className="bg-gradient-to-br from-[#222]/50 to-[#111]/50 rounded-lg p-6 border border-[#74AA9C]/20"
                          >
                                ...
                                return (
                                  ...
                                  >
                                    <div className="flex items-center justify-between">
                                      <div className="flex items-center">
                                        <span className="font-semibold mr-3 text-sm bg-gray-600/50 px-2 py-1 rounded">
                                          {optionLabels[oIndex]}
                                        </span>
