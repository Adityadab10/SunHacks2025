    ...
    <div className={`min-h-screen ${themeClasses.bg} ${themeClasses.text}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 pt-20 pb-16">
        <div className="text-center space-y-8">
          <h1 className="text-6xl font-bold mb-6">
            ...
            <br />
            <span className="text-4xl">Personalized Study Guide Generator</span>
          </h1>
          <p className={`text-xl ${themeClasses.textSecondary} max-w-4xl mx-auto leading-relaxed`}>
            Turn your books, PDFs, and handwritten notes into quizzes, flashcards, and interactive study guides with AI. 
            Experience personalized learning that adapts to your pace and strengthens your weak areas.
          </p>
        ...
        <div className="mt-16 relative">
          <div className={`${themeClasses.bgCard} rounded-2xl p-8 border ${themeClasses.border} shadow-2xl`}>
            ...
            <p className={`text-center mt-4 ${themeClasses.textMuted}`}>AI-powered transformation of your study materials</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className={`${themeClasses.textSecondary} text-lg leading-relaxed`}>
                Students struggle with scattered notes, ineffective revision methods, and lack of personalized learning paths. 
                Traditional study methods don't adapt to individual strengths and weaknesses, leading to wasted time and poor retention.
              </p>
            </div>
            <div>
              <h2 className="text-3xl font-bold mb-6" style={{ color: '#74AA9C' }}>The Solution</h2>
              <p className={`${themeClasses.textSecondary} text-lg leading-relaxed`}>
                StudyGenie automates the creation of personalized study materials using AI. Upload any content, and get 
                intelligent quizzes, flashcards, and summaries that adapt to your learning style and track your progress.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <h2 className="text-4xl font-bold text-center mb-16">
          Powerful Features for <span style={{ color: '#74AA9C' }}>Smart Learning</span>
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className={`${themeClasses.bgCard} rounded-2xl p-8 border ${themeClasses.border} hover:${themeClasses.borderHover} transition-colors`}>
            ...
            <h3 className="text-2xl font-semibold mb-4 text-center">Upload & Extract</h3>
          ...
          <div className={`${themeClasses.bgCard} rounded-2xl p-8 border ${themeClasses.border} hover:${themeClasses.borderHover} transition-colors`}>
            ...
            <h3 className="text-2xl font-semibold mb-4 text-center">Personalized Study Flow</h3>
            <p className={`${themeClasses.textMuted} text-center`}>
          ...
          <div className={`${themeClasses.bgCard} rounded-2xl p-8 border ${themeClasses.border} hover:${themeClasses.borderHover} transition-colors`}>
            ...
            <h3 className="text-2xl font-semibold mb-4 text-center">Smart Flashcard System</h3>
            <p className={`${themeClasses.textMuted} text-center`}>
              Spaced repetition algorithm combined with active recall techniques to maximize retention and optimize your study time.
            </p>
          </div>
          ...
          <div className={`${themeClasses.bgCard} rounded-2xl p-8 border ${themeClasses.border} hover:${themeClasses.borderHover} transition-colors`}>
            ...
            <h3 className="text-2xl font-semibold mb-4 text-center">AI Tutor</h3>
            <p className={`${themeClasses.textMuted} text-center`}>
          ...
          <div className={`${themeClasses.bgCard} rounded-2xl p-8 border ${themeClasses.border} hover:${themeClasses.borderHover} transition-colors`}>
            ...
            <h3 className="text-2xl font-semibold mb-4 text-center">Multilingual Support</h3>
            <p className={`${themeClasses.textMuted} text-center`}>
              Support for English, Hindi, Marathi, and more regional languages, making quality education accessible to diverse learners.
            </p>
          </div>
          ...
          <div className={`${themeClasses.bgCard} rounded-2xl p-8 border ${themeClasses.border} hover:${themeClasses.borderHover} transition-colors`}>
            ...
            <h3 className="text-2xl font-semibold mb-4 text-center">Progress Dashboard</h3>
            <p className={`${themeClasses.textMuted} text-center`}>
              Comprehensive analytics with progress bars, study streaks, knowledge heatmaps, and performance insights to track your growth.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className={`${themeClasses.bgSection} py-20`}>
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-16">
            How <span style={{ color: '#74AA9C' }}>StudyGenie</span> Works
          </h2>
          ...
          <div className="space-y-8">
            <div className={`flex items-center space-x-8 ${themeClasses.bgCardHover} rounded-2xl p-8 border ${themeClasses.borderSection}`}>
              ...
              <div className="flex-1">
                ...
                <p className={themeClasses.textMuted}>Student uploads a Physics chapter PDF or takes a photo of handwritten notes</p>
              </div>
            ...
            <div className={`flex items-center space-x-8 ${themeClasses.bgCardHover} rounded-2xl p-8 border ${themeClasses.borderSection}`}>
              ...
              <div className="flex-1">
                ...
                <p className={themeClasses.textMuted}>Our AI analyzes the content and generates personalized flashcards, quizzes, and summaries</p>
              </div>
            ...
            <div className={`flex items-center space-x-8 ${themeClasses.bgCardHover} rounded-2xl p-8 border ${themeClasses.borderSection}`}>
              ...
              <div className="flex-1">
                ...
                <p className={themeClasses.textMuted}>Student practices with flashcards and takes quizzes with instant feedback</p>
              </div>
              <div className="text-4xl">📚✅❌</div>
            </div>
            ...
            <div className={`flex items-center space-x-8 ${themeClasses.bgCardHover} rounded-2xl p-8 border ${themeClasses.borderSection}`}>
              ...
              <div className="flex-1">
                ...
                <p className={themeClasses.textMuted}>Dashboard updates with progress tracking and AI tutor explains incorrect answers</p>
              </div>
              <div className="text-4xl">📊🎯📈</div>
            </div>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        <h2 className="text-4xl font-bold text-center mb-16">
          Transform Your <span style={{ color: '#74AA9C' }}>Learning Experience</span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Faster Revision</h3>
            <p className={themeClasses.textMuted}>Cut study time by 50% with AI-optimized materials</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className={themeClasses.textMuted}>Adaptive study paths tailored to your strengths and weaknesses</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className={themeClasses.textMuted}>Spaced repetition increases long-term memory by 200%</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className={themeClasses.textMuted}>Regional language support for diverse learners</p>
          </div>
        </div>
      </div>
      ...
      <div className={`${themeClasses.bgSection} py-20`}>
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-12">
            Powered by <span style={{ color: '#74AA9C' }}>Cutting-Edge Technology</span>
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-8">
            {[
              ...
              <div key={index} className={`${themeClasses.bgCard} rounded-xl p-4 border ${themeClasses.border} hover:${themeClasses.borderHover} transition-colors`}>
                ...
                <p className={`text-sm ${themeClasses.textMuted}`}>{tech.name}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-20 text-center">
        <h2 className="text-5xl font-bold mb-8">
          Start Learning Smarter with <span style={{ color: '#74AA9C' }}>StudyGenie</span>
        </h2>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold mb-2" style={{ color: '#74AA9C' }}>StudyGenie</h3>
              <p className={themeClasses.textMuted}>Transforming education with AI</p>
            </div>
            
            <div className="flex space-x-8">
              <Link to="/about" className={`${themeClasses.textMuted} hover:${themeClasses.text} transition-colors`}>About</Link>
              <Link to="/contact" className={`${themeClasses.textMuted} hover:${themeClasses.text} transition-colors`}>Contact</Link>
              <Link to="/privacy" className={`${themeClasses.textMuted} hover:${themeClasses.text} transition-colors`}>Privacy</Link>
            </div>
          ...
          <div className={`border-t ${themeClasses.borderFooter} mt-8 pt-8 text-center`}>
            <p className={themeClasses.textMuted}>&copy; 2025 StudyGenie. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
