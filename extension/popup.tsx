...
import { Play, FileText, BookOpen } from "./components/Icons";
import { YouTubeSummary } from "./components/YouTubeSummary";
import { PdfSummary } from "./components/PdfSummary";
import { NotesWorkspace } from "./components/NotesWorkspace";
import type { TabData, Summary } from "./types";
import "./style.css";

function IndexPopup() {
  const [activeTab, setActiveTab] = useState<'youtube' | 'pdf' | 'notes'>('youtube');
